                ...
                entryProvider {
                    entry<Dashboard> {
                        DashboardScreen(
                            ...
                            onSelectionModeChanged = { dashboardViewModel.onSelectionModeChanged(it) },
                            onDocumentSelectionToggled = { dashboardViewModel.onDocumentSelectionToggled(it) },
                            onBulkDeleteClick = { dashboardViewModel.onBulkDeleteSelected() },
